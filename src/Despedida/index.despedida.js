...
export const Despedida = () => {
    ...
    useEffect(() => {
        // Configura el temporizador apenas se monta el componente
        const timeout = setTimeout(() => {
            setInactive(true);
            navigate('/clientes/salida');
        }, 3000);

        // Ya no necesitamos los event listeners porque no queremos
        // resetear el temporizador con la actividad del usuario
