...
export const Inicio = () => {
  ...
  const styles = {
    ...
    desktop: {
      heading: `absolute font-now top-[20%] left-1/2 -translate-x-1/2 text-gray-500 text-[${Math.min(9, width * 0.09)}vw] leading-[1em] tracking-[0.2em] w-full text-center`,
      ...
      button: `absolute font-now top-[65%] left-1/2 -translate-x-1/2 text-gray-500 border-4 border-gray-500 text-[${Math.min(5, width * 0.05)}vw] tracking-[0.1em] px-10 py-5 w-[50vw] hover:bg-gray-500 hover:text-white transition-colors duration-300`
    }
  };
